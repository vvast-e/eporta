...
$APPLICATION->SetTitle("Популярные товары");?><div style="padding:24px var(--pad-x) 4px"><h1 style="margin:0;font:800 27px 'Manrope';letter-spacing:-0.01em">Популярные товары</h1></div>
<?
	//include module
