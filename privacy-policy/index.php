...
данных, предпринимаемые ______________________ (далее — Оператор).<br>
...
данных, обеспечивающих их доступность в сети интернет<br>
...
распространения).<br>
2.10. Пользователь — любой посетитель данного веб-сайта<br>
...
2.15. Cookies – небольшие текстовые файлы, хранящиеся в браузере посетителей веб-сайта.<br>
При посещении сайта автоматически собираются следующие обезличенные данные:<br>
- тип действия (клик, наведение курсора);<br>
- дата и время действия;<br>
- URL страницы;<br>
- Referer (источник перехода);<br>
- IP-адрес (без идентификации пользователя);<br>
- User-Agent (данные браузера/устройства);<br>
- ClientID (идентификатор браузера);<br>
- экранное разрешение;<br>
- класс HTML-элемента, с которым взаимодействовал пользователь;<br>
- данные о просматриваемых товарах.<br>
Для анализа этих данных Оператор использует сервис(ы) __________________.<br>
<br>
...
обработку персональных данных без согласия субъекта персональных данных при наличии оснований, указанных в Законе
...
и уничтожить персональные данные в порядке и случаях, предусмотренных Законом о персональных
данных;<br>
...
о прекращении обработки персональных данных;<br>
        ...
        <table class="table-simple">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание<br>
                        персональных данных<br>
...
Оператора <b>privacy@mysite.ru</b> с пометкой «Актуализация персональных данных».<br>
8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные,
если иной срок не предусмотрен договором или действующим законодательством.<br>
...
Оператора <b>privacy@mysite.ru</b> с пометкой «Отзыв согласия на обработку персональных
данных».<br>
...
данных.<br>
8.10. Оператор использует файлы cookies (п. 2.15) для:<br>
- обеспечения работы сайта;<br>
- персонализации контента;<br>
- анализа поведения пользователей.<br>
Пользователь может управлять использованием cookies через настройки браузера:<br>
- отключить сохранение cookies;<br>
- удалить существующие файлы;<br>
- заблокировать сбор данных для аналитики.<br>
Отключение cookies может ограничить функциональность сайта.<br>
<br>
...
о намерении осуществлять обработку персональных данных).<br>
...
данных, обратившись к Оператору с помощью электронной почты <b>privacy@mysite.ru.</b><br>
12.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика
действует бессрочно до замены ее новой версией.<br><br><br>
