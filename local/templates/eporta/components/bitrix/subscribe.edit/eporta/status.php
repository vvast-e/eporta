...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	...
	<tr valign="top">
		...
		<td nowrap><?php echo ($arResult['SUBSCRIPTION']['CONFIRMED'] == 'Y' ? GetMessage('subscr_yes') : GetMessage('subscr_no'));?></td>
	...
	<tr>
		...
		<td nowrap><?php echo ($arResult['SUBSCRIPTION']['ACTIVE'] == 'Y' ? GetMessage('subscr_yes') : GetMessage('subscr_no'));?></td>
	</tr>
	<tr>
