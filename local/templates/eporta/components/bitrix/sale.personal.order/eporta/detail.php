...
// EPORTA: страница детали заказа не переверстана в Фазе B (по плану — только список),
// делегируем в вендорский .default ребёнка "sale.personal.order.detail" один в один,
// SEF (/personal/order/detail/#ID#/) при этом полностью сохраняется.
$arDetParams = array(
