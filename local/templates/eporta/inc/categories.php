...
function eportaGetCategoryMap(): array
{
	...
	$map = [
		"mkd" => [
			...
			"IMG" => "mkd",
			// HEADING — заголовок каталога при выбранной категории (задача 09.09.2026: раньше
			// каталог всегда показывал захардкоженный H1 "Межкомнатные двери" независимо от того,
			// какую категорию выбрал покупатель в шапке/на главной — см. catalog/index.php).
			"HEADING" => "Межкомнатные двери",
		],
		"hidden" => [
			"LABEL" => "Скрытые",
			// "Скрытые" добавлен 15.09.2026 — в выгрузке Invi колонка "Категория" заполнена именно
			// так (без "двери"), сравнение PROPERTY_CATEGORY точное по строке. Без этого алиаса
			// значение не матчилось НИ под одну категорию — товар не попадал в фильтр "Скрытые" по
			// шапке/плитке, но оставался виден в общем /catalog/ без фильтра (H1 которого по
			// умолчанию — "Межкомнатные двери"), из-за чего выглядело так, будто Invi "остался в
			// межкомнатных".
			"ALIASES" => ["Скрытые двери", "Скрытые", "СД"],
			"IMG" => "hidden",
			"HEADING" => "Скрытые межкомнатные двери",
		],
		"sliding" => [
			"LABEL" => "Раздвижные",
			"ALIASES" => ["Раздвижные двери", "Раздвижные перегородки", "РД"],
			"IMG" => "sliding",
			"HEADING" => "Раздвижные двери",
		],
		"entrance" => [
			"LABEL" => "Входные",
			"ALIASES" => ["Входные двери", "ВД"],
			"IMG" => "entrance",
			"HEADING" => "Входные двери",
		],
		"arch" => [
			"LABEL" => "Арки и порталы",
			"ALIASES" => ["Арки и порталы", "Арки", "АП"],
			"IMG" => "arch",
			"HEADING" => "Арки и порталы",
		],
		"hardware" => [
			"LABEL" => "Фурнитура",
