...
// ТОЛЬКО дизайн — все параметры bitrix:sale.order.ajax ниже перенесены без единого
// изменения (бизнес-логика/расчёт доставки/оплаты/купонов не трогается). Кастомизация —
// исключительно новый COMPONENT_TEMPLATE "eporta" (байт-в-байт копия вендорского .default,
// PHP/JS не менялись) + CSS поверх вендорских классов в template_styles.css. Боевой
// dresscode/`.default`-шаблон (else-ветка) не тронут.
